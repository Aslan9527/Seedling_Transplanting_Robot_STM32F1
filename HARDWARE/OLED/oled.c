...
void OLED_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE);	 //使能B端口时钟   |RCC_APB2Periph_AFIO
...
void Display(void)  
{	
//	OLED_ShowCHinese16x16(32,0,17,LOGO); //东方红
//	OLED_ShowCHinese16x16(48,0,18,LOGO);
//	OLED_ShowCHinese16x16(64,0,19,LOGO); 
  OLED_ShowString(4,8,"N",16);	
	OLED_ShowCHinese16x16(16,8,20,LOGO); //角度
	OLED_ShowCHinese16x16(32,8,21,LOGO);
  OLED_ShowString(48,8,":",16);
	OLED_ShowCHinese16x16(104,8,22,LOGO);
	
  OLED_ShowString(4,10,"I",16);	
	OLED_ShowCHinese16x16(16,10,7,LOGO); //距离
	OLED_ShowCHinese16x16(32,10,8,LOGO);//
  OLED_ShowString(48,10,":",16);
  OLED_ShowString(104,10,"C",16);
  OLED_ShowString(112,10,"M",16);
	
  OLED_ShowString(4,12,"L",16);	
	OLED_ShowCHinese16x16(16,12,7,LOGO); //距离
	OLED_ShowCHinese16x16(32,12,8,LOGO);//
  OLED_ShowString(48,12,":",16);
  OLED_ShowString(104,12,"C",16);
  OLED_ShowString(112,12,"M",16);	
	
  OLED_ShowString(4,14,"R",16);	
	OLED_ShowCHinese16x16(16,14,7,LOGO); //距离
	OLED_ShowCHinese16x16(32,14,8,LOGO);//
  OLED_ShowString(48,14,":",16);
  OLED_ShowString(104,14,"C",16);
  OLED_ShowString(112,14,"M",16);
}
void OLED_Show(void)  
{	
  OLED_Float(8,56,Now_Angle,3);	
  OLED_ShowNumber(56,10,Distance_IN,3,16);
  OLED_ShowNumber(56,12,Distance_L,3,16);	
  OLED_ShowNumber(56,14,Distance_R,3,16);	
	//  OLED_ShowNumber(56,14,OpenMV_Y,3,16);
}
void display2(void)  
{	
	OLED_ShowCHinese16x16(0,12,14,LOGO); //充电中
	OLED_ShowCHinese16x16(16,12,15,LOGO);//
	OLED_ShowCHinese16x16(32,12,16,LOGO); //
}
void error(void)
{
OLED_ShowChar(0,6,' ',16);	
OLED_ShowChar(8,6,'e',16);
OLED_ShowChar(16,6,'r',16);
OLED_ShowChar(24,6,'r',16);
OLED_ShowChar(32,6,'o',16);
OLED_ShowChar(40,6,'r',16);	
